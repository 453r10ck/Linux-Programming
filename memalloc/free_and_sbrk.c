...
//---./free_and_sbrk [num-allocs] [block-size]
    // manipulate num-allocs
    ...
    printf("Initial preogram break:         %10p\n", sbrk(0));
    ...
    printf("After free(), program break is: %10p", sbrk(0));
